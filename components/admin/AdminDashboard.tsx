...
import { OperationsChecklistPanel } from "@/components/admin/OperationsChecklistPanel";
  ...
  return (
    <>
      ...
      >
        ...
        {tab === "operations_checklist" ? <OperationsChecklistPanel /> : null}
