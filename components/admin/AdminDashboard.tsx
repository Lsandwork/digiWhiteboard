...
import { PackageEligibilityPanel } from "@/components/admin/PackageEligibilityPanel";
  ...
  return (
    <>
      ...
      >
        ...
        {tab === "package_eligibility" ? <PackageEligibilityPanel /> : null}
