...
const PRIMARY_ROLE_OPTIONS: { value: RoleKey; description: string }[] = [
  ...
  { value: "front_desk_coordinator", description: "Push Notices, Yard Push, Grooming Push, Team Log, Owner Follow Up, Active Issues." },
  { value: "team_leader", description: "Team Lead DigiBoard panel: push notices, grooming push, team log, video links, personal notifications, write-ups, and profile settings." },
  { value: "groomer", description: "Groomer DigiBoard panel: grooming push, team log, video links, personal notifications, complaints/requests, and profile settings." },
