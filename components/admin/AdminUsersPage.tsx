...
const PRIMARY_ROLE_OPTIONS: { value: RoleKey; description: string }[] = [
  ...
  { value: "front_desk_coordinator", description: "Push Notices, Yard Push, Grooming Push, Front Desk Log, Owner Follow Up, Active Issues, Fitdog Alerts, Walks Board, Vet Visits, and Track Incidents." },
