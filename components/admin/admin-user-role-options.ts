...
export const PRIMARY_ROLE_OPTIONS: { value: RoleKey; description: string }[] = [
  ...
  { value: "front_desk_coordinator", description: "Push Notices, Yard Push, Team Log, Owner Follow Up, Active Issues." },
  { value: "team_leader", description: "Team Lead panel: push notices, grooming push, team log, and more." },
  { value: "groomer", description: "Groomer panel: grooming push, team log, notifications, and profile." },
