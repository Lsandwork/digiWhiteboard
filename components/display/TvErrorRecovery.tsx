...
export function TvErrorRecovery({
  error,
  reset,
  title = "Display reconnecting"
}: {
    ...
    <main className="grid min-h-screen place-items-center bg-[#02060b] px-6 text-center text-white">
      <div className="max-w-lg">
        ...
        <p className="mt-3 text-base text-slate-300">
          The digital whiteboard hit a temporary error. Reloading automatically in {secondsLeft}s so
          the TV does not stay blank.
        </p>
