...
import { GingrRouteGeneratorWorkspace } from "@/components/gingr-route-generator/GingrRouteGeneratorWorkspace";
...
export function GingrRouteGeneratorPageClient({ username, role, access }: Props) {
    ...
    <div className="admin-theme">
      <div className={`admin-layout admin-layout--gingr ${sidebarCollapsed ? "admin-layout--collapsed" : ""}`}>
        <Sidebar
          ...
          activePath="/admin/gingr-route-generator"
          board={board}
          username={username}
          role={role}
