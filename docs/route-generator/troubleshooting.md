...
Document operational details for **troubleshooting** in this file as the feature is rolled out. Live Fitdog credentials and the current Samsara sample template must be validated by Fitdog before claiming production verification.
