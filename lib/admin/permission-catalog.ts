...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      p("view_fitdog_alerts", "View Sports App Alerts", "View Sports App payment and operations alerts under Operations."),
      p("manage_fitdog_alerts", "Manage Sports App Alerts", "Assign, resolve, and sync Sports App payment alerts."),
