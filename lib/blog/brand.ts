...
export const FITDOG_PUBLIC_URLS = {
  ...
  daycare: process.env.NEXT_PUBLIC_FITDOG_DAYCARE_URL?.trim() || "https://www.fitdog.com/services/daycare",
  boarding: process.env.NEXT_PUBLIC_FITDOG_BOARDING_URL?.trim() || "https://www.fitdog.com/services/boarding",
  training: process.env.NEXT_PUBLIC_FITDOG_TRAINING_URL?.trim() || "https://www.fitdog.com/services/training",
  hikes: process.env.NEXT_PUBLIC_FITDOG_HIKES_URL?.trim() || "https://www.fitdog.com/services/adventures",
  grooming: process.env.NEXT_PUBLIC_FITDOG_GROOMING_URL?.trim() || "https://www.fitdog.com/services/grooming",
  transportation: process.env.NEXT_PUBLIC_FITDOG_TRANSPORT_URL?.trim() || "https://www.fitdog.com/services/transportation",
