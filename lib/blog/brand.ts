...
/** Verified against https://www.fitdog.com (Aug 2026). */
export const FITDOG_PUBLIC_URLS = {
  ...
  /** @deprecated Use `about` — /why-fitdog returns 404 on fitdog.com */
  whyFitdog: process.env.NEXT_PUBLIC_FITDOG_WHY_URL?.trim() || "https://www.fitdog.com/about/",
  locations: process.env.NEXT_PUBLIC_FITDOG_LOCATIONS_URL?.trim() || "https://www.fitdog.com/contact/",
  members:
  ...
  pricing: process.env.NEXT_PUBLIC_FITDOG_PRICING_URL?.trim() || "https://www.fitdog.com/pricing/",
  daycare: process.env.NEXT_PUBLIC_FITDOG_DAYCARE_URL?.trim() || "https://www.fitdog.com/club-home/",
  boarding: process.env.NEXT_PUBLIC_FITDOG_BOARDING_URL?.trim() || "https://www.fitdog.com/club-home/boarding/",
  ...
  grooming: process.env.NEXT_PUBLIC_FITDOG_GROOMING_URL?.trim() || "https://www.fitdog.com/club-home/grooming/",
  transportation: process.env.NEXT_PUBLIC_FITDOG_TRANSPORT_URL?.trim() || "https://www.fitdog.com/club-home/",
  instagram: process.env.NEXT_PUBLIC_FITDOG_INSTAGRAM_URL?.trim() || "https://www.instagram.com/fitdogsports/",
  facebook: process.env.NEXT_PUBLIC_FITDOG_FACEBOOK_URL?.trim() || "https://www.facebook.com/FitdogSportsClub/",
  tiktok: process.env.NEXT_PUBLIC_FITDOG_TIKTOK_URL?.trim() || "https://www.tiktok.com/@fitdogsports",
  youtube: process.env.NEXT_PUBLIC_FITDOG_YOUTUBE_URL?.trim() || "https://www.youtube.com/@fitdogsports",
  socialHandle: "@fitdogsports"
} as const;
