...
export const lobbyAssets = {
  ...
  heartIcon: `${LOBBY_ASSET_BASE}/icons/svg/fitdog-dog-profile.svg`,
  calendarIcon: `${LOBBY_ASSET_BASE}/icons/svg/fitdog-dog-profile.svg`,
  sectionDogIcon: `${LOBBY_ASSET_BASE}/icons/svg/fitdog-dog-profile.svg`,
