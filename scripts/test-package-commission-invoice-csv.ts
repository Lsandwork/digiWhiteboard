...
assert.match(importsSrc, /imported > 0 \|\| !inserted.timedOut/);
...
assert.match(postgresImportSrc, /lock_timeout/);
assert.match(postgresImportSrc, /preferSession: true/);
assert.match(postgresImportSrc, /IMPORT_INSERT_CHUNK = 20/);
